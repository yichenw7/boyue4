        ...
        <el-row style="margin-top: 20px;">
  			<el-col :span="12" :offset="4">
		        <el-form :model="formData" :rules="rules" ref="formData" label-width="110px" class="demo-formData">
					...
					<el-form-item label="游戏代号" prop="phone">
						<el-input v-model.number="formData.phone" maxLength="11" placeholder="游戏的英文字母代号，跟生成的包名相关"></el-input>
					</el-form-item>
					<el-form-item label="游戏描述" prop="description">
						<el-input type="textarea" :autosize="{ minRows: 2, maxRows: 10}" v-model="formData.description"></el-input>
					</el-form-item>					
